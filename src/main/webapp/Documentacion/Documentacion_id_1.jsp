...
<head>
    ...
    <script>
        ...
        function irADocumentacion() {
            window.location.href = "/Examen/Documentacion/Documentacion_id_1.jsp";
        }

        function cargarAudioInicial() {
            var audio = document.getElementById('audioElement');
            audio.src = "Info_python/py_a1.mp3"; 
            audio.load(); 
            audio.play(); 
        }
        ...
        function cambiarImagenYAudio() {
            ...
            var nuevaDirImagen = "Info_python/py_" + nuevoIdInfo + ".png";
            var nuevoNombreAudio = "Info_python/py_a" + nuevoIdInfo + ".mp3";
...
<body>
    ...
    <div class="content">
        <div class="info">
            <img src="Info_python/py_<%= idInfoActual %>.png">
            <audio id="audioElement" controls autoplay>
                <source src="Info_python/py_a1.mp3" type="audio/mpeg"> 
            </audio>
        </div>
    </div>
    ...
    <a id="descargarCertificado" href="/Examen/certificado.jsp?idCurso=1" style="display: none;" >Obtener Certificado</a>
